-- Auth/RLS setup without dollar-quoted function bodies.
-- Use this if Supabase SQL Editor fails with:
-- - no language specified
-- - no function body specified
--
-- Run after 0001_initial_schema.sql. Do not run 0005 or 0006 if this file is used.

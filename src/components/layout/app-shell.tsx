          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  "flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-300 transition-all duration-200 hover:bg-slate-900 hover:text-white",
                  active && "bg-gradient-to-r from-cyan-700 to-blue-700 text-white shadow-md"
                )}
              >
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-border/80 bg-white/85 px-4 backdrop-blur-md md:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              className="inline-flex h-9 items-center gap-2 rounded-lg border border-border bg-white px-3 text-xs font-semibold text-slate-700 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-slate-100"

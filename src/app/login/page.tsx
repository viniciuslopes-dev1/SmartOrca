...
function LoginContent() {
  ...
  return (
    <main className="h-dvh overflow-hidden bg-[#071126] text-slate-950">
      <section className="relative h-full w-full overflow-hidden bg-[#071126]">
        <section className="relative z-10 flex h-full min-h-0 items-start px-5 pb-[clamp(0.75rem,2vh,2rem)] pt-[clamp(1.25rem,4vh,2.5rem)] text-white sm:px-10 lg:px-16">
          ...
          <div className="relative z-10 w-full max-w-[580px]">
            <Link href="/dashboard" className="mb-[clamp(1rem,3vh,2.5rem)] flex w-fit flex-col gap-1.5">
              <span className="flex h-[clamp(3rem,7vh,4rem)] w-[clamp(12.5rem,18vw,14rem)] items-center overflow-hidden rounded-lg border border-white/10 bg-white px-3 shadow-sm">
            ...
            <div className="mb-[clamp(1rem,3vh,2.25rem)]">
              <h1 className="text-[2.25rem] font-black leading-tight text-white sm:text-[3rem]">Entrar no sistema</h1>
              <p className="mt-3 max-w-md text-base font-medium leading-6 text-slate-300">
            ...
            <form className="grid gap-4" onSubmit={handleSubmit(submit)}>
              <div>
                ...
                <input
                  ...
                  className="h-11 w-full rounded-md border border-white/10 bg-white px-4 text-base font-semibold text-slate-900 shadow-[0_12px_28px_rgba(0,0,0,0.18)] outline-none transition placeholder:text-slate-400 focus:border-[#d6a13a] focus:ring-3 focus:ring-[#d6a13a]/15"
                />
              ...
              <button
                ...
                className="mt-1 inline-flex h-11 items-center justify-center gap-2 rounded-md bg-[#d6a13a] px-5 text-base font-black text-[#071126] shadow-[0_14px_28px_rgba(0,0,0,0.2)] transition hover:-translate-y-0.5 hover:bg-[#e0ad4b] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {signIn.isPending ? "Entrando..." : "Entrar"}
                <ArrowRight className="h-4 w-4" />
              </button>

              <div className="mt-1 flex flex-col gap-2 border-t border-white/10 pt-3 text-sm font-bold text-slate-300 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="mt-4 flex items-center gap-3 border-t border-white/10 pt-3 text-xs font-semibold leading-5 text-slate-300">
        ...
        <section className="pointer-events-none absolute bottom-[clamp(1rem,3vh,2rem)] right-8 top-[clamp(1rem,3vh,2rem)] hidden w-[31%] overflow-hidden rounded-l-[2rem] border border-white/10 bg-[#071126] shadow-[0_28px_80px_rgba(0,0,0,0.28)] md:block">
          <img
